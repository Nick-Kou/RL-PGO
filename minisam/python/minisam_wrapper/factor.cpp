...
public:
  ...
  Eigen::VectorXd error(const Variables& variables) const override {
    ...
    Eigen::VectorXd getter() override{
        PYBIND11_OVERLOAD_PURE(Eigen::VectorXd, Factor, getter());
    }
...
public:
  ...
  Eigen::VectorXd error(const Variables& variables) const override {
    ...
    Eigen::VectorXd getter() override{
        PYBIND11_OVERLOAD_PURE(Eigen::VectorXd, NumericalFactor, getter());
    }
